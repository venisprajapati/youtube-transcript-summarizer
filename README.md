...
![Logo](https://github.com/venisprajapati/youtube-transcript-summarizer-web-browser-extension/blob/main/icon.png)
...
```
git clone https://github.com/venisprajapati/youtube-transcript-summarizer-api.git
git clone https://github.com/venisprajapati/youtube-transcript-summarizer-frontend.git
git clone https://github.com/venisprajapati/youtube-transcript-summarizer-web-browser-extension.git
```
